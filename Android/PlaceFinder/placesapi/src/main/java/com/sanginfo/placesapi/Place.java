...
public class Place {
    protected String PHOTO_URL = "https://maps.googleapis.com/maps/api/place/photo?";
    ...
    public String getThumbnailURL(String key){
        String url="";
        if(!photoRef.equalsIgnoreCase("")){
            url= PHOTO_URL+"key="+key+"&&photoreference="+photoRef+"&&maxheight=50";
        }
        return url;
    }

    public String getLargeURL(String key){
        String url="";
        if(!photoRef.equalsIgnoreCase("")){
            url= PHOTO_URL+"key="+key+"&&photoreference="+photoRef+"&&maxheight=400";
        }
        return url;
    }
